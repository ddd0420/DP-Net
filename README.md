...
Data could be got at [LA](https://github.com/yulequan/UA-MT/tree/master/data) Pancreas-NIH [CoraNet](https://github.com/koncle/CoraNet) and [ACDC](https://github.com/HiLab-git/SSL4MIS/tree/master/data/ACDC).
